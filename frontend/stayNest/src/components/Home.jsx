          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="relative z-10 text-center lg:text-left">
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-3 lg:justify-start justify-center">
                ...
                <Link
                  to="/register"
                  className="group inline-flex items-center justify-center px-6 py-3 text-sm font-semibold rounded-lg text-primary-700 bg-white hover:bg-gray-50 transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl"
                >
